    ...
    <div className="bg-white rounded-xl border border-gray-200 p-5">
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="text-right">
          <p className="text-[10px] font-semibold text-gray-400 tracking-widest">BALANCE</p>
          <p className="text-xl font-bold text-gray-900">$0.00</p>
        </div>
      </div>

      <button className="w-full flex items-center justify-center gap-2 bg-white text-gray-700 text-sm font-medium py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors mb-4">
        <Share2 size={15} />
        Invite friends
      </button>
        ...
        {friends.map((f) => (
          <div key={f.name} className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="bg-gray-100 text-gray-500 text-[10px] font-semibold px-2 py-0.5 rounded-full">Sample</span>
